Public Class StepData_SVARCheck
    ...
    Public Function GetParam2() As String Implements StepDataParam.GetParam2
        Return DetectFormEvent.TextBox_SVARCheck.Text
    End Function
    ...
    Public Overrides Function GetSVARCheck(ByVal iRowIndex As Integer) As String
