Public Class StepData_FileRead
    ...
    Public Function GetParam2() As String Implements StepDataParam.GetParam2
        Return DetectFormEvent.ComboBox_FileToSVAR.Text
    End Function
    ...
    Public Overrides Function GetFileRead_SVARIndex(ByVal iRowIndex As Integer) As Integer
